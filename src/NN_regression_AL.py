...
class VarNet(NeuralNetRegressor):
    ...
    def get_loss(self, y_pred, y_true, X=None, training=False):
        ...
        mean_CRPS = asymmLaplace_accrue_torch.get_avg_CRPS_torch(k, eps, lam=l)

        # eta = asymmLaplace_accrue_torch.calc_eta_torch(eps, k, self.lam)
        RS = asymmLaplace_accrue_torch.analytical_RS_torch(eps, k, l)
